...
Table with:
- Detected archetype
- Domain (platform/data/distributed/backend/testing/quality)
- Function (build/maintain/lead/deploy)
- Seniority
...
- Backend / API → prioritize delivery speed and user-facing features
- Platform / Infra → prioritize developer productivity and tooling impact
- Data / Streaming → prioritize pipeline reliability and throughput metrics
- Distributed Systems → prioritize systems design and performance
- SDET / Test Automation → prioritize automation coverage and CI/CD integration
- Quality / Performance → prioritize quality metrics and test infrastructure
...
2. **"Sell senior without lying" plan**: archetype-specific phrases, concrete achievements to highlight, how to position seniority as an advantage
...
- Backend / API → emphasize delivery speed and production reliability
- Platform / Infra → emphasize developer impact and tooling decisions
- Data / Streaming → emphasize pipeline design and operational stability
- Distributed Systems → emphasize architecture decisions and trade-offs
- SDET / Test Automation → emphasize automation framework design and coverage metrics
- Quality / Performance → emphasize quality infrastructure and performance benchmarks

Also include:
- 1 recommended case study (which project to present and how)
- Red-flag questions and how to answer them (e.g., "why did you leave your last role?", "do you have direct reports?")
