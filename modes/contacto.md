...
3. **Select primary target**: the person who would benefit most from having this candidate there
...
4. **Generate message** with 3-sentence framework adapted to contact type:
   ...
   - **Sentence 2 (Proof)**: Data point that answers their screening questions before they ask (e.g., "5 years building backend systems, currently in Chicago, available immediately")
