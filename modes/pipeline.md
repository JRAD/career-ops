...
- [ ] https://boards.greenhouse.io/company/jobs/456 | Company Inc | Senior Backend Engineer
- [!] https://private.url/job — Error: login required

## Processed
- [x] #143 | https://jobs.example.com/posting/789 | Acme Corp | Backend Engineer | 4.2/5 | PDF ✅
- [x] #144 | https://boards.greenhouse.io/xyz/jobs/012 | BigCo | SDET | 2.1/5 | PDF ❌
```
...
- **`local:` prefix**: Read the local file. Example: `local:jds/acme-backend.md` → read `jds/acme-backend.md`
