...
- JD says "REST API design" and CV says "built backend APIs" → change to "REST API design and backend service development"
- JD says "test automation framework" and CV says "wrote Playwright tests" → change to "test automation framework design using Playwright"
- JD says "CI/CD pipeline" and CV says "integrated with Jenkins" → change to "CI/CD pipeline integration via Jenkins"

**NEVER add skills the candidate doesn't have. Only reformulate real experience with the exact vocabulary of the JD.**

## HTML Template

Use the template at `cv-template.html`. Replace `{{...}}` placeholders with personalized content:
