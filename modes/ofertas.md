...
| Tech stack modernity | 5% | 5=modern stack, 1=legacy |
...
Ask the user for the offers if they are not already in context. Can be text, URLs, or references to offers already evaluated in the tracker.
